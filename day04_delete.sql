...
CREATE TABLE cocuk
    ...
    SAVEPOINT CICEK; -- YEDEKLEME
    use sys;
    SELECT * FROM cocuk;
    -- id'si 124'ten butuk olanlari silin
    
    delete from cocuk where id>124;
    ROLLBACK TO CICEK; -- TEKRAR VERILERI GETIRDI
...
INSERT INTO cocuklar VALUES(123, 'Ali Can', 'Hasan',75);
    ...
    rollback to kiraz;
    truncate table cocuklar;-- table'in icindeki bilgileri siler geri getiremeyiz.rollback de ise yaramaz
...
CREATE TABLE talebeler
	...
	REFERENCES talebeler(id) ON DELETE CASCADE     --  CHILD 'I SILMEDEN DE DIREK PARENT SILINEBILIR
	);
