...
select * from personel where isim like '-e%' and isim like'%y%';
select *from personel;
/*-------------------------------------------------------------------------
...
INSERT INTO lise (isim,derece,son_degisiklik_tarihi) VALUES ('1010','Suleyman Karaca',45,'2022-12-05');
...
select derece from lise where isim='Elif Kesen';
-- Q3 : Derecesi 90dan buyuk olan ogrencilerin okul_no ve isimlerini listeleyin.
select okul_no,isim from lise where derece>90;
