...
-- Ismi null olaan kAyitlari listeleyin
select * from insanlar where isim is null;
-- Ismi null olan kayitlari 'isimsiz' olarak guncelleyin
update insanlar
set isim='isimsiz'
where isim is null;
-- ismi 'isimsiz ' olanlari silin
...
select *
from insanciklar
order by ssn; -- isimleri kayit sirasina gore getiriyor

-- Soru 6: Insanciklar tablosundaki tum kayitlari Soyisimler ters sirali,
-- isimler Natural sirali olarak listeleyin.
select *
from insanciklar
order by soyisim desc, isim asc; -- soyisim once oldugu icin soyisim azaltir,soyisim ayni olursa  isim devreye girer ismi artirarak gelir
...
-- Soru 8: Insanciklar tablosundaki tum kayitlari
-- adresler ters sirali, isimler ters sirali ,soyisimler ters sirali olarak listeleyin.
select *
from insanciklar
