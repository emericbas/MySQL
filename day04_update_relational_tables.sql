...
tedarikci_id int(4),
urun_id INT,
urun_ismi VARCHAR(10),
musteri_ismi varchar(15),
...
SELECT * FROM tedarik;
SELECT * FROM urun;
-- lg'deki ali can'i 'Veli Can' yapalim
UPDATE  tedarik
...
-- irtibati Merve Temiz olan kaydin sirket ismini getirin
SELECT isim
FROM tedarik
...
-- WHERE id; yazmaya gerek yok, yazsak da problem olmaz
...
-- 3) Ismi A ile baslayan butun isimlerin  urun_fiyatlarini %15 artirin 
UPDATE mart_satislar
